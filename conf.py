...
_C.MODEL.ARCH = 'Wu2020Adversarial_extra'
...
# (SampleAwareStaticBatchNorm2d, SampleAwareOnlineBatchNorm2d)
_C.OPTIM.BN_FUN = 'SampleAwareStaticBatchNorm2d'
